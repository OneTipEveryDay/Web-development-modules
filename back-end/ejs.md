separate the font end  and back end  <br>
user javascript code inside html file we use ejs file
...
<body>
  <h1>
    Hello <%= "a string " or varible >
  </h1>
</body>

```
### steps
> ceate folder and init `NPM`
> then write index.js
> create views/index.ejs
> and write for your varible that deffine inside index.js
 ### example1 
 index.js:
...
## example 3
<img width="1918" height="981" alt="image" src="https://github.com/user-attachments/assets/122a7767-785e-41d6-a877-4d0a09dc53bd" />
...
```
## example 3
<img width="1918" height="981" alt="image" src="https://github.com/user-attachments/assets/152149bf-0d3a-41f1-8937-a23c77c2d78f" />
